...
class UNet_2Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=False, is_ds=False):
    ...
    def forward(self, inputs):
       ...
       #X_31 = self.up_concat31(X_40, X_30)
        ...
        if self.is_ds:
            return torch.tanh(final_3)
        else:
            return F.tanh(final_3)
