...
def mobile_net_v2(pretrained=False):
    ...
    #     path_to_model = './pretrain_model/mobilenetv2.pth.tar'
...
def Back_Net(pretrained = False):
    ...
    if pretrained:
        ...
        path_to_model = "/root/tmp/pycharm_project_815/M_M_Semi-Supervised/code/AVA/1_srccbest_balance_data_SPAQ_distort_CHUK_goodaddscore_back_acc_8325_srcc_8098_2021_06_15_07_40.pth"
...
def Fore_Net(pretrained = True):
    ...
    if pretrained:
        ...
        path_to_model = "/root/tmp/pycharm_project_815/M_M_Semi-Supervised/code/AVA/1_srcc_best_balance_data_SPAQ_distort_CHUK_goodaddscore_fore_vacc0.835091083413231_srcc0.8026898736523915.pth"
