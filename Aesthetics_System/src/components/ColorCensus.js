...
class ColorCensus extends Component {
  ...
  render() {
    ...
    console.log("cens",this.props.colorReady)

    return (
      <div className="App">
        <ImageShowcase setScoreLayer={this.setScoreLayer}
                       censusColors={this.censusColors}
                       resetApp={this.resetApp}
                       colorData = {this.state.colorData}
                       colorReady={this.props.colorReady}/>
        <ColorCard colors={this.state.clusterColors}/>
